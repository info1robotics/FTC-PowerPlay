...
//@Disabled
//@Autonomous(name = "Preload Kill SH | Right")
//@Autonomous(name = "KILLBOT RIGHT")
@Autonomous(name = "AUTONOMIE LEGIT RIGHT")
@Config
public class AutoTestHighDefense extends AutoOpMode {
