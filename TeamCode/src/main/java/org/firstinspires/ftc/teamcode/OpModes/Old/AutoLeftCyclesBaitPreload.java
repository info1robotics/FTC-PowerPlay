...
//@Config
//public class AutoLeftCyclesBaitPreload extends AutoBase {
...
//                .splineTo(new Vector2d(-30, -9), Math.toRadians(45))
//                .build();
//
...
//                .build();
//
//        align_to_park = drive.trajectoryBuilder(spline_to_high.end(), true)
...
//                async(
//                        trajectory(align_to_park),
//                        inline(() -> linkage.goToLevel(0, 0.5)),
