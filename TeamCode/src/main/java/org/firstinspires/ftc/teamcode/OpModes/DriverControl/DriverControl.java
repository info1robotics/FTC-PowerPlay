...
public class DriverControl extends LinearOpMode {
    public double targetAngle, turretVelocity, linkageVelocity, angleThreshold;
...
//                    gamepad1.right_stick_x,
            ...
            if(gamepad2.right_stick_button){targetAngle = -90;}
            if(gamepad2.left_stick_button){targetAngle = 90;}
            if(gamepad2.circle){targetAngle =0;}
            if(gamepad2.touchpad){targetAngle = 180;}
            if(gamepad2.dpad_up){targetHeight=400;}
